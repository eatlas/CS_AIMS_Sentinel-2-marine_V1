...
#     - R1_DeepFalse
#       - *.tif
# Global output structure not shown
...
styles = ['R1_DeepMarine','R2_DeepMarine','R1_ReefTop','R1_Shallow','R1_TrueColour','R2_TrueColour','R1_DeepFalse',
'R2_DeepFalse','R1_B2ReefBoundary','R1_B3ReefBoundary','DeepMarine','Shallow','R1_Slope','R2_Slope']
...
for srcRegionDir in srcRegionDirs:
	...
	for srcFile in srcFiles:
		...
		# Examples: 
		# CS_AIMS_Sentinel2-marine_V0_R1_DeepMarine_55KFA_2016-2018-n5.tif
		# CS_AIMS_Sentinel2-marine_V0_R2_DeepMarine_55KFA_2016-2018-n9.tif
		# CS_AIMS_Sentinel2-marine_V0_R1_ReefTop_55KHA_2016-2018-n4.tif
